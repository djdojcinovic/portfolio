...
minixhr('https://api.github.com/users/djdojcinovic', startPage)
...
function footerComponent () {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/djdojcinovic">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
      <a href="mailto:djdojcinovic@gmail.com ">
